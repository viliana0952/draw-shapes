...
namespace Library_kr_471221012
{
    ...
    public class Flag:Shape
    {
        ...
        public override void Paint(IGraphics graphics)
        {
            ...
            graphics.DrawRectangle(Color, _colorFill, Location.X, Location.Y, Width, (Height / 3));
            fl++;
            graphics.DrawRectangle(Color, _colorFill, Location.X, (Location.Y + Height / 3), Width, (Height / 3));
            fl++;
            graphics.DrawRectangle(Color, _colorFill, Location.X, (Location.Y + 2 * Height / 3), Width, (Height / 3));
            fl = 1;
        }
